    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-blue-900">
      ...
      <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4 pt-20">
        ...
        <div className="animate-bounce-in">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed animate-slide-up-fade stagger-1">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20 animate-slide-up-fade stagger-2">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="group border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/50 hover:scale-105 transition-all duration-500 text-lg px-8 py-4 backdrop-blur-sm animate-bounce-in"
